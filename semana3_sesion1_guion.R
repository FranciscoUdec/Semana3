...
#
# Nombre: Francisco Inostroza    Fecha: [25/08/2023
#
...
ingreso == linea_pobreza #el == se usa para comparar numerosiguales
ingreso != linea_pobreza #Los que son diferentes 
...
ecivil <- c("casado","viudo","casado","soltero","soltero","soltero")

civilfactor <- factor(ecivil,
                      levels = c("casado","soltero","viudo"))
